...
set CLASSPATH=%APP_HOME%\lib\MyMavenToGradle-1.0-SNAPSHOT.jar


@rem Execute MyMavenToGradle
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MY_MAVEN_TO_GRADLE_OPTS%  -classpath "%CLASSPATH%" com.example.App %*
...
if not ""=="%MY_MAVEN_TO_GRADLE_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
